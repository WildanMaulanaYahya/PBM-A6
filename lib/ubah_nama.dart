...
class UbahNama extends StatefulWidget {
  UbahNama({Key? key}) : super(key: key);
...
class _UbahNamaState extends State<UbahNama> {
        ...
        body: FutureBuilder<DocumentSnapshot<Object?>>(
            ...
            builder: (context, snapshot) {
              if (snapshot.connectionState == ConnectionState.done) {
                ...
                controller.text = data["nama_lengkap"];
                return SafeArea(
                    child: Column(
                  children: [
                    ...
                    Container(
                      ...
                      child: Row(
                        children: [
                          ...
                          TextButton(
                              onPressed: () =>
                                  _editNama(controller.text, Get.arguments),
  ...
  void _editNama(String nama, String docID) async {
    DocumentReference docdata =
        FirebaseFirestore.instance.collection('user').doc(docID);
    try {
      await docdata.update({"nama_lengkap": nama});
